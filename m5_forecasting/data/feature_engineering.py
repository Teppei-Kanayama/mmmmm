...
class MakeFeature(gokart.TaskOnKart):
    ...
    def run(self):
        ...
        output = self._run(data, self.is_train, feature1, feature2, feature3, mean_encoding_feature)
        self.dump(output)

    @classmethod
    def _run(cls, data, is_train: bool, feature1, feature2, feature3, mean_encoding_feature):

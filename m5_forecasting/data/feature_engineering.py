...
class MakeFeature(gokart.TaskOnKart):
    ...
    def requires(self):
        ...
        return dict(data=self.merged_data_task, feature1=feature1_task)
    ...
    @staticmethod
    def _merge_outside_feature(data, feature1):
